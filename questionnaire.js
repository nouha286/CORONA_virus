...
var questions =[
    ...
    new Question('Êtes-vous enceinte ?',['oui','non','Homme'],null,'radio','facteurpronostique'),
...
function algorithm(){
    ...
    {
        if (facteurdegravMaj==0 && facteurdegravMin==0) results="Votre situation ne relève probablement pas du Covid-19. Un avis médical est recommandé. Au moindre doute, appelez le 141."; 
        if ((facteurdegravMaj>0 || facteurdegravMin>0) || facteurpronostiques>0) results=" Un avis médical est recommandé. Au moindre doute, appelez le 141."; 
...
<p style=" font-size: xx-large">${results}</p>
<hr>
